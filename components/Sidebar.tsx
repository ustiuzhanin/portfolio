...
const Sidebar = () => {
  return (
    <div>
      ...
      {/* address */}
      <div className='py-5 my-5 bg-gray-200 mx--1 location--wrapper'>
      ...
      <button className='w-8/12 px-5 py-5 my-2 text-white rounded-full bg-gradient-to-r from-green to-blue-400'>
        Email Me!
      </button>
      <button className='w-8/12 px-5 py-5 my-2 text-white rounded-full bg-gradient-to-r from-green to-blue-400'>
        Toggle Theme
